...
#let emitter-config-table = table(
  ...
  [#text("Spring Snow Crabapple")], [#text("2-3 x 2 gph")], [#text("Establishing tree; 2 minimum, 3 preferred. ~1.9-2.8 gal/cycle.")],
  [#text("Autumn Brilliance Serviceberry")], [#text("2-3 x 2 gph")], [#text("South-facing full sun adds demand. ~1.9-2.8 gal/cycle.")],
  [#text("Emperor Japanese Maple")], [#text("3 x 2 gph")], [#text("Highest demand; full afternoon sun; shallow roots. ~2.8 gal/cycle.")],
  [#text("Wichita Blue Juniper")], [#text("1 x 2 gph")], [#text("Drought tolerant; overwatering is the greater risk. ~0.93 gal/cycle.")],
  [#text("Dwarf Globe Blue Spruce")], [#text("1 x 2 gph")], [#text("Moderate-low demand; clay crown drainage critical. ~0.93 gal/cycle.")],
  [#text("Mops Mugo Pine")], [#text("1 x 2 gph")], [#text("Drought tolerant; sensitive to overwatering. ~0.93 gal/cycle.")],
  [#text("Peking Cotoneaster")], [#text("1 x 2 gph")], [#text("Very drought tolerant. ~0.93 gal/cycle.")],
  [#text("Yankee Doodle Lilac")], [#text("2 x 2 gph")], [#text("Larger establishing shrub. ~1.9 gal/cycle.")],
  [#text("Miss Kim Lilac")], [#text("1 x 2 gph")], [#text("Established; audit existing emitter before runtime changes.")],
  [#text("Dark Knight Bluebeard")], [#text("1 x 2 gph")], [#text("Prefers dry; cap emitter in September. ~0.93 gal/cycle.")],
  [#text("Daylilies (Mixed)")], [#text("1 x 2 gph")], [#text("Established (2022); afternoon shade. Audit existing emitter before runtime changes.")],
  [#text("White Yarrow")], [#text("1 x 2 gph")], [#text("Very drought tolerant; cap emitter in September. ~0.93 gal/cycle.")],
  [#text("Agastache Sunset Hyssop")], [#text("1 x 2 gph")], [#text("Drought tolerant; cap emitter in September. ~0.93 gal/cycle.")],
  [#text("Rocky Mountain Penstemon")], [#text("1 x 2 gph")], [#text("Native; drought tolerant; cap emitter in September. ~0.93 gal/cycle.")],
  [#text("Autumn Joy Sedum")], [#text("1 x 2 gph")], [#text("Drought tolerant; cap emitter in September. ~0.93 gal/cycle.")],
  [#text("Blonde Ambition Blue Grama")], [#text("1 x 2 gph")], [#text("Native prairie grass; very drought tolerant. ~0.93 gal/cycle.")],
  [#text("Northwind Switchgrass")], [#text("1 x 2 gph")], [#text("Native grass; moderate-low demand. ~0.93 gal/cycle.")],
)

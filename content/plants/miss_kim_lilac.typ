...
#plant-header("Miss Kim Lilac", "Syringa pubescens subsp. patula 'Miss Kim'", "miss_kim", establishment: plant-established("miss_kim_lilac"), lifespan: plant-lifespan("miss_kim_lilac"), tier: plant-tier("miss_kim_lilac"), failure: plant-failure("miss_kim_lilac"))[
 Miss Kim is a compact, disease-resistant Korean lilac prized for its intensely fragrant lavender flowers in late May and deep burgundy fall foliage. Far smaller than common lilacs (6–7 ft. tall and wide). Slow-growing by nature — plants typically put on 4–8 inches per year. Located on the east side of the house with morning sun only — afternoon shade from the house begins around midday. This exposure is favorable in Colorado: afternoon shade reduces powdery mildew risk and leaf scorch compared to full-sun placement.
]
...
Prune immediately after bloom (June) — lilacs bloom on old wood and summer buds are set right after flowering, so pruning can remove next year's flower buds. Remove dead wood and the oldest, thickest canes every 2–3 years to maintain vigor and open the center. Do not shear into a box — this destroys the natural form and most of the flower buds. Light tip removal after bloom is fine.

=== Wildlife Value

The intensely fragrant late-May blooms are excellent for butterflies (especially monarchs and swallowtails) and native bees. Hummingbirds occasionally visit but prefer tubular flowers. House finches and collared doves may perch in the structure but do not typically use it for nesting. The shrub's density offers limited cover value. Cottontail rabbits may browse tender young shoots in spring — this is a common observation especially on plants that are slow to establish.
